...
class PieChart @JvmOverloads constructor(
    ...
    private val paintList = listOf(
        ContextCompat.getColor(context, R.color.color_view_1),
        ContextCompat.getColor(context, R.color.color_view_2),
        ContextCompat.getColor(context, R.color.color_view_3),
        ContextCompat.getColor(context, R.color.color_view_4),
        ContextCompat.getColor(context, R.color.color_view_5),
        ContextCompat.getColor(context, R.color.color_view_6),
        ContextCompat.getColor(context, R.color.color_view_7),
        ContextCompat.getColor(context, R.color.color_view_8),
        ContextCompat.getColor(context, R.color.color_view_9),
        ContextCompat.getColor(context, R.color.color_view_10)
    ).map { paintColor ->
        Paint().apply {
            color = paintColor
            style = Paint.Style.FILL
    ...
    private var partByCategories = categoryList
        .groupBy { it.category }
        .mapValues { entry -> ((entry.value.sumOf { it.amount }) * 360).toFloat() / total }
        .toList()
    ...
    override fun onRestoreInstanceState(state: Parcelable?) {
        ...
        super.onRestoreInstanceState(bundle.parcelable(BUNDLE_KEY_STATE))
    }
